...
namespace CLNPrintMonitor.Controller
{
    public partial class PrinterController : Form
    {
        ...
        public void InvokeUpdateUI(PrinterController target)
        {
            ...
            target.lblDefaultInputCapacity.Text = "Capacidade de " + printer.DefaultInput.Capacity.ToString() + " folhas";
            target.lblDefaultInputScale.Text = "Tamanho " + printer.DefaultInput.Scale;
            target.lblDefaultInputType.Text = printer.DefaultInput.Type;
            target.lblDefaultInputStatus.Text = printer.DefaultInput.Status;
            target.grbSecondaryInput.Text = printer.SupplyMF.Name;
            target.lblSupplyMfInputCapacity.Text = "Capacidade de " + printer.SupplyMF.Capacity.ToString() + " folhas";
            target.lblSupplyMfInputScale.Text = "Tamanho " + printer.SupplyMF.Scale;
